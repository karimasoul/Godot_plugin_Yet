...
# for teste
#gros blem ici çmr
func generate_main_menu(is_visible_volume: bool = true, is_visible_window: bool = true, is_visible_resolution: bool = true, is_visible_vertical: bool = true, is_visible_title: bool = true, is_visible_bmain: bool = true, is_visible_bresume: bool = true, is_visible_exit: bool = true, scene_name: String = ""):
...
# ResolutionBox
	if is_visible_resolution :
		...
		ResolutionButton4.texture_normal=load("res://addons/yetanotherplugins/assets/WindowRes.png")
